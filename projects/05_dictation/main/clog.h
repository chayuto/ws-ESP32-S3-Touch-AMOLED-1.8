...
/*
 * One record per utterance, on the card, in the same JSON Lines shape. This is the
 * artefact that makes an accuracy argument possible after the fact - 02's equivalent
 * is how the black-panel afternoon was actually diagnosed. Everything needed to
 * reconstruct a decode goes in, including MX-1's raw_string.
 */
