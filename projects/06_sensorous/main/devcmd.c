...
void devcmd_init(void)
{
    ...
    ESP_LOGI(TAG, "listening: m=maintenance M=mode S=scan-now e=eject o=mount c=census-dump z=census-clear "
                  "i=info d=debug-all p=power b=bright x=panel-reinit t=thermal-sim");
}
