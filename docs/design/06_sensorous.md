...
| **M2** | Memory and timing: internal RAM with both stacks up, worst loop turn, sweep and window durations, records per hour | **done** 2026-09-18 — 40 min stationary: 30.4 KB internal free with **zero drift**, low-water 17.4 KB **set during a scan, not in maintenance mode**, 7.88 MB PSRAM, worst loop turn 335 ms, Wi-Fi sweep 2.20 s, BLE window 4.01 s, 357 sensor records/hour, IMU at a median 101 Hz. See the README's stability table |
